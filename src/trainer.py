...
from src.model.model import NAML
...
class Trainer(BaseTrainer):
    ...
    def train(self):
        ...
        news_encoder = NewsEncoder.from_pretrained(args.pretrained_embedding, config=config,
                                                   ...
                                                   window_size=args.window_size, word_embed_dim=args.word_embed_dim)
        user_encoder = UserEncoder(news_encoder=news_encoder, query_dim=args.query_dim)
        model = NAML(user_encoder=user_encoder, news_encoder=news_encoder)
